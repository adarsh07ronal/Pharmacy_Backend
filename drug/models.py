...
class MedicineEfficacyClassification(models.Model):
...
class Medicine(models.Model):
	...
	drug_classification = models.ForeignKey(MedicineEfficacyClassification,on_delete=models.SET_NULL,null=True,blank=True)
